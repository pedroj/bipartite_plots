...
```{r vertex_attr, eval=TRUE, echo=TRUE}
# mymat <- read.delim("./data-raw/data.txt", row.names=1)   # Not run.
# mynet<- bip_init_network(mymat)
# mynet %v% "fam" = ifelse(network.vertex.names %in% c(1,2,3,5,7,8,9,10,12,
#                         13,21,22,26,27,30,31)
#    ), "Muscicapidae", "Paridae")
# ggnet2(mynet, color = "fam")
